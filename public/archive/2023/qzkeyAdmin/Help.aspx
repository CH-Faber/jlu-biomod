<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Help.aspx.cs" Inherits="Manager_Help" %>
        ...
        <tr>
            ...
            <td valign="top" bgcolor="#F7F8F9">
                ...
                <div style="line-height: 20px;">
                    <p style="background-color: #f2f2f2; padding: 5px;">
                        <strong>1.如何设置QQ可以允许临时会话？</strong><br />
                        答案在这里：<a href="http://jingyan.baidu.com/article/91f5db1bde7ff91c7e05e374.html?qq-pf-to=pcqq.c2c" target="_blank">http://jingyan.baidu.com/article/91f5db1bde7ff91c7e05e374.html?qq-pf-to=pcqq.c2c</a>
                    </p>
                    <p style="background-color: #f2f2f2; padding: 5px;">
                        <strong>2.在使用过程中遇到问题，如何联系你们？</strong><br />
                        售后问题联系我们，我们有专人对您的问题进行详细的解答。</p>
                    <p style="background-color: #f2f2f2; padding: 5px;">
                        <strong>3.发布修改了资料首页没更新过来怎么回事？</strong><br />
                        启用生成静态的情况下，每次数据有变动都要在生成静态里面保存更新一下。</p>
                </div>
                <!--内容结束-->
            </td>
