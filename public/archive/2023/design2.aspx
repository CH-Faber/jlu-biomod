...
<body>
    ...
    <!--content-->
    <%--<div class="index1" <%--style="background: url(<%=mc.ShowColumnKeyById(intClassID,"path") %>) center center no-repeat; background-size: cover;"--%> style="height: 358px;">
  <%--      <div class="i1Tit">
            <%=strColumnSubName %> <span class="fontColor1"><%=mc.ShowColumnKeyById(intClassID,"remarks") %></span>
        </div>

        <div class="i1Links" style="    right: 176px;">
            <ul>
