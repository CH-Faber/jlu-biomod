<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Aboutus.aspx.cs" Inherits="Content" %>
...
<body>
    ...
    <div class="about">
        ...
        <div class="aboTop">
            ...
            <div class="aboImg img">
                <img src="<%=mc.ShowColumnKeyById(intClassID,"path") %>" />
            </div>
        </div>
          <%showNews(intClassID, 20); %>
                    <%for (int j = 0; j < intNews; j++)
