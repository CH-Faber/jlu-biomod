<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Journal.aspx.cs" Inherits="Content" %>
...
<body>
    ...
    <!--content-->
    <div class="journal">
        <div class="jouTit"><%=strColumnSubName %></div>

        <div class="jouLine"></div>

        <div class="swiper jouSwiper">
            <div class="swiper-wrapper">
                <%showNews(intClassID, 100); %>
                ...
                <div class="swiper-slide">
                    <div class="part">
                        <div class="year"><span><%=title %></span></div>
                        <div class="info">
                          <%=content %>
                        </div>
                    </div>
            ...
            <div class="swiper-pagination jouPage"></div>
        </div>
    </div>
